// Creacion del modelo de dispositivo electronicio 

const { Model } = require('sequelize');
//const ModeloBase = require('./modeloBase');
const DescripcionDispositivo = require('./descripcionDispositivo');
const EstadoDispositivo = require('./estadoDispositivo');
  ...
  class DispositivoElectronico extends Model {
     ...
     */
      ...
      static associate(models) {
        ...
        DispositivoElectronico.belongsTo(models.DescripcionDispositivo, { foreignKey: "id_descripcion_dispositivo" });

        DispositivoElectronico.belongsTo(models.EstadoDispositivo, { foreignKey: "id_estado_dispositivo" });
      }
  }
