...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('courseDetail', [
      {
        ...
        image2ur2: 'https://example.com/c++_intro_image2.jpg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        image2ur2: 'https://example.com/python_intro_image2.jpg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        image2ur2: 'https://example.com/design_intro_image2.jpg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        image2ur2: 'https://example.com/photography_intro_image2.jpg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        image2ur2: 'https://example.com/marketing_intro_image2.jpg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        image2ur2: 'https://example.com/english_intro_image2.jpg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ], {});
