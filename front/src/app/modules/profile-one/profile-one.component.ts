...
export class ProfileOneComponent implements OnInit, AfterViewInit {
  listProfile: Profile[] = [];
  profileData: any; // Variable para almacenar los datos proporcionados
  selectedColor: string = 'rgb(58, 83, 134);';
  ...
  ngOnInit(): void {
   ...
   async downloadPDF() {
    ...
    const profileContainer: HTMLElement | null = document.getElementById('profile-one');
